...
###############################################################################
def main(observation_directory='/data/share/pipeline/Observation',
         inspection_directory='/data/share/pipeline/Observation/results/inspection',
         logfile='/data/share/pipeline/Observation/logs/pipeline.log',
         h5parmdb='/data/share/pipeline/Observation/results/cal_values/solutions.h5',
         MSfile='[]'):
    """
